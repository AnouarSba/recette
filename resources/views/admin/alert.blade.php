...
$(function() {
    ...
    var table = $('.data-table').DataTable({
        ...
        createdRow: function(row, data, index) {
            ...
            if (data.b_name == null || data.b_name == 0) {
                $('td:eq(2)', row).css('background-color', 'grey'); //Original Date
                $('td:eq(2)', row).css('color', 'white'); //Original Date
                $('td:eq(2)', row).css('text-align', 'center'); //Original Date
                $('td:eq(2)', row).html('');
                $('td:eq(2)', row).attr('colspan', 3);
                $('td:eq(2)', row).html('تبليغ عام'); //Original Date
            ...
            if (data.status == null || data.status == 0) {
                $('td:eq(6)', row).css('background-color', 'grey'); //Original Date
                $('td:eq(6)', row).html(''); //Original Date
            }
            if (data.status == 1) {
                $('td:eq(6)', row).html('محفوظ'); //Original Date
            }
            if (data.status == 2) {
                $('td:eq(6)', row).html('تمت معالجتها');
            }
