                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <div class="card card-plain">
                            <center>
                                <img src="{{'assets/image/log.png'}}" alt="" width="100px" height="100px"
                    ...
                    <div
                        ...
                        <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                            style="background-image: url('https://sourceonepartners.com/wp-content/uploads/2014/04/importance_Background_screening_resized.jpg');
              background-size: cover;">
                            <span class="mask bg-gradient-primary opacity-6"></span>
                            <h4 class="mt-5 text-white font-weight-bolder position-relative">Statistique</h4>
