...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('https://www.ismartrecruit.com/upload/blog/main_image/7_Best_Practices_for_Pre-Employment_Background_Checks.jpg'); background-position: top;">
